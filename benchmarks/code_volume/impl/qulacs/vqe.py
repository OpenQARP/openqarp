...
import numpy as np
from common import build_ansatz, energy, molecular_hamiltonian, prepared_state, uccsd_generators
...
circuit, layout = build_ansatz(n_qubits, generators)
reference = prepared_state(n_qubits, range(n_electrons))

result = minimize(
    lambda parameters: energy(circuit, layout, observable, parameters, reference),
